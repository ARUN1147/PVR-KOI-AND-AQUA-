                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex flex-col items-end">
                                    ...
                                    <span className="text-[11px] text-gray-400 font-medium">{role === 'STAFF' ? 'Field Staff' : 'Management'}</span>
                                </div>
                                <div className="h-10 w-10 bg-gradient-to-tr from-primary-500 to-aqua-500 rounded-full border-2 border-white shadow-md flex items-center justify-center text-white font-bold">
